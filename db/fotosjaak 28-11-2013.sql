...
--
-- Machine: localhost
-- Genereertijd: 28 nov 2013 om 14:33
...
-- Databank: `am1b`
--
CREATE DATABASE `am1b` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `am1b`;
...
-- Databank: `h3`
--
CREATE DATABASE `h3` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `h3`;
--
...
--
-- Gegevens worden uitgevoerd voor tabel `CHARACTER_SETS`
--
...
--
-- Gegevens worden uitgevoerd voor tabel `COLLATIONS`
--
...
--
-- Gegevens worden uitgevoerd voor tabel `COLLATION_CHARACTER_SET_APPLICABILITY`
--
...
--
-- Gegevens worden uitgevoerd voor tabel `COLUMNS`
--
...
('def', 'am1b', 'users', 'firstname', 1, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'am1b', 'users', 'infix', 2, NULL, 'YES', 'varchar', 10, 10, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
('def', 'am1b', 'users', 'surname', 3, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'am1b', 'users', 'city', 4, NULL, 'NO', 'varchar', 150, 150, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(150)', '', '', 'select,insert,update,references', ''),
('def', 'am1b', 'users', 'postalcode', 5, NULL, 'NO', 'varchar', 6, 6, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(6)', '', '', 'select,insert,update,references', ''),
('def', 'am1b', 'users', 'street', 6, NULL, 'NO', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'am1b', 'users', 'house_number', 7, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(2)', '', '', 'select,insert,update,references', ''),
('def', 'am1b', 'users', 'dob', 8, NULL, 'NO', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update,references', ''),
('def', 'am1b', 'users', 'sex', 9, NULL, 'NO', 'varchar', 10, 10, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
('def', 'am1b', 'users', 'email', 10, NULL, 'NO', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'am1b', 'users', 'user_name', 11, NULL, 'NO', 'varchar', 35, 35, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(35)', '', '', 'select,insert,update,references', ''),
('def', 'am1b', 'users', 'password', 12, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', 'am1b', 'users', 'game_type', 13, NULL, 'NO', 'varchar', 35, 35, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(35)', '', '', 'select,insert,update,references', ''),
('def', 'am1b', 'users', 'favo_game', 14, NULL, 'NO', 'varchar', 60, 60, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(60)', '', '', 'select,insert,update,references', ''),
('def', 'am1b', 'users', 'marital_status', 15, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'am1b', 'users', 'position', 16, 'customer', 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'am1b-fotosjaak', 'login', 'login_id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'am1b-fotosjaak', 'login', 'email', 2, NULL, 'NO', 'varchar', 200, 200, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(200)', '', '', 'select,insert,update,references', ''),
('def', 'am1b-fotosjaak', 'login', 'password', 3, NULL, 'NO', 'varchar', 12, 12, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(12)', '', '', 'select,insert,update,references', ''),
('def', 'am1b-fotosjaak', 'login', 'userrole', 4, NULL, 'NO', 'enum', 13, 13, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'enum(''customer'',''administrator'',''root'',''photographer'',''developer'')', '', '', 'select,insert,update,references', ''),
('def', 'am1b-fotosjaak', 'login', 'isactivated', 5, 'no', 'NO', 'enum', 3, 3, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'enum(''yes'',''no'')', '', '', 'select,insert,update,references', ''),
('def', 'am1b-fotosjaak', 'login', 'regiterdate', 6, NULL, 'NO', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', '', '', 'select,insert,update,references', ''),
('def', 'am1b-fotosjaak', 'user', 'user_id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', '', 'select,insert,update,references', ''),
('def', 'am1b-fotosjaak', 'user', 'firstname', 2, NULL, 'NO', 'varchar', 200, 200, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(200)', '', '', 'select,insert,update,references', ''),
('def', 'am1b-fotosjaak', 'user', 'infix', 3, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'am1b-fotosjaak', 'user', 'surname', 4, NULL, 'NO', 'varchar', 300, 300, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(300)', '', '', 'select,insert,update,references', ''),
('def', 'am1b-fotosjaak', 'user', 'address', 5, NULL, 'NO', 'varchar', 200, 200, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(200)', '', '', 'select,insert,update,references', ''),
('def', 'am1b-fotosjaak', 'user', 'addressnumber', 6, NULL, 'NO', 'varchar', 12, 12, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(12)', '', '', 'select,insert,update,references', ''),
('def', 'am1b-fotosjaak', 'user', 'city', 7, NULL, 'NO', 'varchar', 300, 300, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(300)', '', '', 'select,insert,update,references', ''),
('def', 'am1b-fotosjaak', 'user', 'zipcode', 8, NULL, 'NO', 'varchar', 6, 6, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(6)', '', '', 'select,insert,update,references', ''),
('def', 'am1b-fotosjaak', 'user', 'country', 9, NULL, 'NO', 'varchar', 300, 300, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(300)', '', '', 'select,insert,update,references', ''),
('def', 'am1b-fotosjaak', 'user', 'phonenumber', 10, NULL, 'NO', 'varchar', 13, 13, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(13)', '', '', 'select,insert,update,references', ''),
('def', 'am1b-fotosjaak', 'user', 'mobilenumber', 11, NULL, 'NO', 'varchar', 13, 13, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(13)', '', '', 'select,insert,update,references', ''),
('def', 'am1b-fotosjaak', 'users', 'firstname', 1, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'am1b-fotosjaak', 'users', 'infix', 2, NULL, 'YES', 'varchar', 10, 10, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
('def', 'am1b-fotosjaak', 'users', 'surname', 3, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'am1b-fotosjaak', 'users', 'city', 4, NULL, 'NO', 'varchar', 150, 150, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(150)', '', '', 'select,insert,update,references', ''),
('def', 'am1b-fotosjaak', 'users', 'postalcode', 5, NULL, 'NO', 'varchar', 6, 6, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(6)', '', '', 'select,insert,update,references', ''),
('def', 'am1b-fotosjaak', 'users', 'street', 6, NULL, 'NO', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'am1b-fotosjaak', 'users', 'house_number', 7, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(2)', '', '', 'select,insert,update,references', ''),
('def', 'am1b-fotosjaak', 'users', 'dob', 8, NULL, 'NO', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update,references', ''),
('def', 'am1b-fotosjaak', 'users', 'sex', 9, NULL, 'NO', 'varchar', 10, 10, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
('def', 'am1b-fotosjaak', 'users', 'email', 10, NULL, 'NO', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'am1b-fotosjaak', 'users', 'user_name', 11, NULL, 'NO', 'varchar', 35, 35, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(35)', '', '', 'select,insert,update,references', ''),
('def', 'am1b-fotosjaak', 'users', 'password', 12, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', 'am1b-fotosjaak', 'users', 'game_type', 13, NULL, 'NO', 'varchar', 35, 35, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(35)', '', '', 'select,insert,update,references', ''),
('def', 'am1b-fotosjaak', 'users', 'favo_game', 14, NULL, 'NO', 'varchar', 60, 60, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(60)', '', '', 'select,insert,update,references', ''),
('def', 'am1b-fotosjaak', 'users', 'marital_status', 15, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'am1b-fotosjaak', 'users', 'position', 16, 'customer', 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
...
('def', 'selma', 'student', 'Studentnummer', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(2)', '', '', 'select,insert,update,references', ''),
('def', 'selma', 'student', 'Achternaam', 2, NULL, 'NO', 'varchar', 40, 40, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(40)', '', '', 'select,insert,update,references', ''),
('def', 'selma', 'student', 'Roepnaam', 3, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'selma', 'student', 'Klas', 4, NULL, 'NO', 'varchar', 4, 4, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(4)', '', '', 'select,insert,update,references', ''),
('def', 'selma', 'student', 'Tel', 5, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(4)', '', '', 'select,insert,update,references', ''),
('def', 'selma', 'student', 'Email', 6, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', 'selma', 'student', 'Geboortedatum', 7, NULL, 'NO', 'varchar', 10, 10, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
('def', 'selma', 'werknemer', 'wnr', 1, '0', 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'selma', 'werknemer', 'achternaam', 2, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'selma', 'werknemer', 'voorletters', 3, NULL, 'NO', 'varchar', 10, 10, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
('def', 'selma', 'werknemer', 'voorvoegsel', 4, NULL, 'YES', 'varchar', 10, 10, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
('def', 'selma', 'werknemer', 'adres', 5, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', 'selma', 'werknemer', 'postcode', 6, NULL, 'NO', 'varchar', 7, 7, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(7)', '', '', 'select,insert,update,references', ''),
('def', 'selma', 'werknemer', 'woonplaats', 7, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', 'selma', 'werknemer', 'tel', 8, NULL, 'NO', 'varchar', 11, 11, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(11)', '', '', 'select,insert,update,references', ''),
('def', 'selma', 'werknemer', 'datum_in_dienst', 9, NULL, 'NO', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update,references', ''),
('def', 'selma', 'werknemer', 'sal', 10, NULL, 'NO', 'decimal', NULL, NULL, 8, 2, NULL, NULL, 'decimal(8,2)', '', '', 'select,insert,update,references', ''),
('def', 'selma', 'werknemer', 'chef', 11, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'selma', 'werknemer', 'sofinummer', 12, NULL, 'NO', 'varchar', 10, 10, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(10)', '', '', 'select,insert,update,references', '');
...
--
-- Gegevens worden uitgevoerd voor tabel `ENGINES`
--
...
--
-- Gegevens worden uitgevoerd voor tabel `GLOBAL_STATUS`
--
...
('COM_SHOW_TABLE_STATUS', '360'),
('COM_SHOW_TABLES', '32'),
('COM_SHOW_TRIGGERS', '180'),
...
('COMPRESSION', 'OFF'),
('CONNECTIONS', '41'),
('CREATED_TMP_DISK_TABLES', '528'),
('CREATED_TMP_FILES', '5'),
('CREATED_TMP_TABLES', '1826'),
('DELAYED_ERRORS', '0'),
...
('HANDLER_DISCOVER', '0'),
('HANDLER_PREPARE', '0'),
('HANDLER_READ_FIRST', '102'),
('HANDLER_READ_KEY', '21'),
('HANDLER_READ_LAST', '0'),
('HANDLER_READ_NEXT', '2058'),
('HANDLER_READ_PREV', '0'),
('HANDLER_READ_RND', '0'),
('HANDLER_READ_RND_NEXT', '11931'),
('HANDLER_ROLLBACK', '0'),
('HANDLER_SAVEPOINT', '0'),
...
('INNODB_BUFFER_POOL_PAGES_FLUSHED', '88'),
('INNODB_BUFFER_POOL_PAGES_FREE', '7935'),
('INNODB_BUFFER_POOL_PAGES_MISC', '1'),
('INNODB_BUFFER_POOL_PAGES_TOTAL', '8192'),
('INNODB_BUFFER_POOL_READ_AHEAD_RND', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '0'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '3649'),
('INNODB_BUFFER_POOL_READS', '254'),
('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
('INNODB_BUFFER_POOL_WRITE_REQUESTS', '188'),
('INNODB_DATA_FSYNCS', '25'),
('INNODB_DATA_PENDING_FSYNCS', '0'),
('INNODB_DATA_PENDING_READS', '0'),
('INNODB_DATA_PENDING_WRITES', '0'),
('INNODB_DATA_READ', '6344704'),
('INNODB_DATA_READS', '264'),
('INNODB_DATA_WRITES', '64'),
('INNODB_DATA_WRITTEN', '1459200'),
('INNODB_DBLWR_PAGES_WRITTEN', '44'),
('INNODB_DBLWR_WRITES', '5'),
('INNODB_HAVE_ATOMIC_BUILTINS', 'ON'),
('INNODB_LOG_WAITS', '0'),
('INNODB_LOG_WRITE_REQUESTS', '21'),
('INNODB_LOG_WRITES', '9'),
...
('INNODB_PAGES_READ', '253'),
('INNODB_PAGES_WRITTEN', '44'),
...
('KEY_BLOCKS_UNUSED', '13378'),
('KEY_BLOCKS_USED', '18'),
('KEY_READ_REQUESTS', '138'),
('KEY_READS', '18'),
...
('THREADS_RUNNING', '1'),
('UPTIME', '2083'),
('UPTIME_SINCE_FLUSH_STATUS', '2083');
...
--
-- Gegevens worden uitgevoerd voor tabel `GLOBAL_VARIABLES`
--
...
('DATADIR', 'C:\\wampnew\\wamp\\bin\\mysql\\mysql5.5.24\\data\\'),
...
('BASEDIR', 'C:/wampnew/wamp/bin/mysql/mysql5.5.24'),
...
('CHARACTER_SETS_DIR', 'C:\\wampnew\\wamp\\bin\\mysql\\mysql5.5.24\\share\\charsets\\'),
('LOG_BIN', 'ON'),
...
('THREAD_CACHE_SIZE', '0'),
('LC_MESSAGES_DIR', 'C:\\wampnew\\wamp\\bin\\mysql\\mysql5.5.24\\share\\'),
...
('PID_FILE', 'C:\\wampnew\\wamp\\bin\\mysql\\mysql5.5.24\\data\\rutger-PC.pid'),
('KEY_CACHE_DIVISION_LIMIT', '100'),
('COLLATION_SERVER', 'latin1_swedish_ci'),
('GENERAL_LOG_FILE', 'C:\\wampnew\\wamp\\bin\\mysql\\mysql5.5.24\\data\\rutger-PC.log'),
('FLUSH_TIME', '1800'),
...
('LOG_ERROR', 'C:\\wampnew\\wamp\\logs\\mysql.log'),
...
('PLUGIN_DIR', 'C:\\wampnew\\wamp\\bin\\mysql\\mysql5.5.24\\lib\\plugin\\'),
...
('SLOW_QUERY_LOG_FILE', 'C:\\wampnew\\wamp\\bin\\mysql\\mysql5.5.24\\data\\rutger-PC-slow.log'),
...
--
-- Gegevens worden uitgevoerd voor tabel `KEY_COLUMN_USAGE`
--
...
('def', 'am1b-fotosjaak', 'PRIMARY', 'def', 'am1b-fotosjaak', 'login', 'login_id', 1, NULL, NULL, NULL, NULL),
('def', 'am1b-fotosjaak', 'PRIMARY', 'def', 'am1b-fotosjaak', 'user', 'user_id', 1, NULL, NULL, NULL, NULL),
...
('def', 'selma', 'PRIMARY', 'def', 'selma', 'werknemer', 'wnr', 1, NULL, NULL, NULL, NULL);
...
--
-- Gegevens worden uitgevoerd voor tabel `PARTITIONS`
--
...
('def', 'information_schema', 'CHARACTER_SETS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 384, 0, 16434816, 0, 0, '2013-11-28 14:33:13', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 231, 0, 16704765, 0, 0, '2013-11-28 14:33:13', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 195, 0, 16357770, 0, 0, '2013-11-28 14:33:13', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMNS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2013-11-28 14:33:13', '2013-11-28 14:33:13', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMN_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2565, 0, 16757145, 0, 0, '2013-11-28 14:33:13', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ENGINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 490, 0, 16574250, 0, 0, '2013-11-28 14:33:13', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'EVENTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2013-11-28 14:33:13', '2013-11-28 14:33:13', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'FILES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2677, 0, 16758020, 0, 0, '2013-11-28 14:33:13', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2013-11-28 14:33:13', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2013-11-28 14:33:13', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'KEY_COLUMN_USAGE', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4637, 0, 16762755, 0, 0, '2013-11-28 14:33:13', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARAMETERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2013-11-28 14:33:13', '2013-11-28 14:33:13', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARTITIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2013-11-28 14:33:13', '2013-11-28 14:33:13', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PLUGINS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2013-11-28 14:33:13', '2013-11-28 14:33:13', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROCESSLIST', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2013-11-28 14:33:13', '2013-11-28 14:33:13', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROFILING', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 308, 0, 16562084, 0, 0, '2013-11-28 14:33:13', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4814, 0, 16767162, 0, 0, '2013-11-28 14:33:13', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ROUTINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2013-11-28 14:33:13', '2013-11-28 14:33:13', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMATA', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3464, 0, 16738048, 0, 0, '2013-11-28 14:33:13', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2179, 0, 16736899, 0, 0, '2013-11-28 14:33:13', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2013-11-28 14:33:13', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2013-11-28 14:33:13', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'STATISTICS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 5753, 0, 16752736, 0, 0, '2013-11-28 14:33:13', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9450, 0, 16764300, 0, 0, '2013-11-28 14:33:13', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLESPACES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 6951, 0, 16772763, 0, 0, '2013-11-28 14:33:13', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2504, 0, 16721712, 0, 0, '2013-11-28 14:33:13', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2372, 0, 16748692, 0, 0, '2013-11-28 14:33:13', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TRIGGERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2013-11-28 14:33:13', '2013-11-28 14:33:13', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'USER_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 1986, 0, 16726092, 0, 0, '2013-11-28 14:33:13', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'VIEWS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2013-11-28 14:33:13', '2013-11-28 14:33:13', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 13107200, 0, 0, '2013-11-28 14:33:13', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_TRX', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4534, 0, 16766732, 0, 0, '2013-11-28 14:33:13', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2013-11-28 14:33:13', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCK_WAITS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 599, 0, 16749238, 0, 0, '2013-11-28 14:33:13', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2013-11-28 14:33:13', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 13107200, 0, 0, '2013-11-28 14:33:13', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCKS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 31244, 0, 16746784, 0, 0, '2013-11-28 14:33:13', NULL, NULL, NULL, '', '', NULL),
('def', 'am1b', 'users', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 16384, 16384, NULL, 0, 8388608, '2013-11-07 11:56:17', NULL, NULL, NULL, '', '', NULL),
('def', 'am1b-fotosjaak', 'login', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 8388608, '2013-11-28 14:03:42', NULL, NULL, NULL, '', '', NULL),
('def', 'am1b-fotosjaak', 'user', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 8388608, '2013-11-28 14:31:31', NULL, NULL, NULL, '', '', NULL),
('def', 'am1b-fotosjaak', 'users', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 16384, 16384, NULL, 0, 8388608, '2013-11-22 10:07:20', NULL, NULL, NULL, '', '', NULL),
('def', 'mysql', 'columns_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 227994731135631359, 4096, 0, '2012-04-19 13:45:09', '2012-04-19 13:45:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'db', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 440, 880, 123848989752688639, 5120, 0, '2012-04-19 13:45:09', '2012-04-19 13:45:10', '2012-04-19 13:45:10', NULL, '', '', NULL),
('def', 'mysql', 'event', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2012-04-19 13:45:09', '2012-04-19 13:45:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'func', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 162974011515469823, 1024, 0, '2012-04-19 13:45:09', '2012-04-19 13:45:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'general_log', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
('def', 'mysql', 'help_category', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 38, 581, 22078, 163536961468891135, 3072, 0, '2012-04-19 13:45:09', '2012-04-19 13:45:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'help_keyword', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 465, 197, 91605, 55450570411999231, 16384, 0, '2012-04-19 13:45:09', '2012-04-19 13:45:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'help_relation', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1029, 9, 9261, 2533274790395903, 19456, 0, '2012-04-19 13:45:09', '2012-04-19 13:45:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'help_topic', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 508, 875, 444876, 281474976710655, 20480, 0, '2012-04-19 13:45:09', '2012-04-19 13:45:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'host', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 110056715893866495, 2048, 0, '2012-04-19 13:45:09', '2012-04-19 13:45:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'ndb_binlog_index', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-04-19 13:45:09', '2012-04-19 13:45:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'plugin', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-04-19 13:45:09', '2012-04-19 13:45:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'proc', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2012-04-19 13:45:09', '2012-04-19 13:45:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'procs_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 239253730204057599, 4096, 0, '2012-04-19 13:45:09', '2012-04-19 13:45:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'proxies_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 693, 693, 195062158860484607, 5120, 0, '2012-04-19 13:45:10', '2012-04-19 13:45:10', '2012-04-19 13:45:10', NULL, '', '', NULL),
('def', 'mysql', 'servers', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 433752939111120895, 1024, 0, '2012-04-19 13:45:09', '2012-04-19 13:45:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'slow_log', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
('def', 'mysql', 'tables_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 239535205180768255, 4096, 0, '2012-04-19 13:45:09', '2012-04-19 13:45:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 1970324836974591, 1024, 0, '2012-04-19 13:45:09', '2012-04-19 13:45:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone_leap_second', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 3659174697238527, 1024, 0, '2012-04-19 13:45:09', '2012-04-19 13:45:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone_name', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 55450570411999231, 1024, 0, '2012-04-19 13:45:09', '2012-04-19 13:45:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone_transition', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 4785074604081151, 1024, 0, '2012-04-19 13:45:09', '2012-04-19 13:45:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone_transition_type', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 10696049115004927, 1024, 0, '2012-04-19 13:45:09', '2012-04-19 13:45:10', NULL, NULL, '', '', NULL),
('def', 'mysql', 'user', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 53, 212, 281474976710655, 2048, 0, '2012-04-19 13:45:09', '2012-04-19 13:45:10', NULL, NULL, '', '', NULL),
...
('def', 'selma', 'student', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 5461, 16384, NULL, 0, 8388608, '2013-11-15 08:34:53', NULL, NULL, NULL, '', '', NULL),
('def', 'selma', 'werknemer', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 20, 819, 16384, NULL, 16384, 8388608, '2013-11-08 10:18:51', NULL, NULL, NULL, '', '', NULL);
...
--
-- Gegevens worden uitgevoerd voor tabel `PLUGINS`
--
...
--
-- Gegevens worden uitgevoerd voor tabel `PROCESSLIST`
--

INSERT INTO `PROCESSLIST` (`ID`, `USER`, `HOST`, `DB`, `COMMAND`, `TIME`, `STATE`, `INFO`) VALUES
(40, 'root', 'localhost:51201', 'h3', 'Query', 0, 'executing', 'SELECT * FROM `information_schema`.`PROCESSLIST`');
...
--
-- Gegevens worden uitgevoerd voor tabel `SCHEMATA`
--

INSERT INTO `SCHEMATA` (`CATALOG_NAME`, `SCHEMA_NAME`, `DEFAULT_CHARACTER_SET_NAME`, `DEFAULT_COLLATION_NAME`, `SQL_PATH`) VALUES
('def', 'information_schema', 'utf8', 'utf8_general_ci', NULL),
('def', 'am1b', 'latin1', 'latin1_swedish_ci', NULL),
('def', 'am1b-fotosjaak', 'latin1', 'latin1_swedish_ci', NULL),
('def', 'h3', 'latin1', 'latin1_swedish_ci', NULL),
('def', 'mysql', 'latin1', 'latin1_swedish_ci', NULL),
('def', 'performance_schema', 'utf8', 'utf8_general_ci', NULL),
('def', 'selma', 'latin1', 'latin1_swedish_ci', NULL),
...
--
-- Gegevens worden uitgevoerd voor tabel `SCHEMA_PRIVILEGES`
--
...
--
-- Gegevens worden uitgevoerd voor tabel `SESSION_STATUS`
--
...
('INNODB_BUFFER_POOL_READ_AHEAD', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '0'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '3796'),
('INNODB_BUFFER_POOL_READS', '254'),
('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
('INNODB_BUFFER_POOL_WRITE_REQUESTS', '188'),
('INNODB_DATA_FSYNCS', '25'),
...
('THREADS_RUNNING', '1'),
('UPTIME', '2084'),
('UPTIME_SINCE_FLUSH_STATUS', '2084');
...
--
-- Gegevens worden uitgevoerd voor tabel `SESSION_VARIABLES`
--
...
('def', 'am1b-fotosjaak', 'login', 0, 'am1b-fotosjaak', 'PRIMARY', 1, 'login_id', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'am1b-fotosjaak', 'user', 0, 'am1b-fotosjaak', 'PRIMARY', 1, 'user_id', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
...
('def', 'selma', 'werknemer', 0, 'selma', 'PRIMARY', 1, 'wnr', 'A', 20, NULL, NULL, '', 'BTREE', '', ''),
('def', 'selma', 'werknemer', 1, 'selma', 'ind_achternaam', 1, 'achternaam', 'A', 20, NULL, NULL, '', 'BTREE', '', '');
...
('def', 'information_schema', 'CHARACTER_SETS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 384, 0, 16434816, 0, 0, NULL, '2013-11-28 14:33:13', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=43690', ''),
('def', 'information_schema', 'COLLATIONS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 231, 0, 16704765, 0, 0, NULL, '2013-11-28 14:33:13', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=72628', ''),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 195, 0, 16357770, 0, 0, NULL, '2013-11-28 14:33:13', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=86037', ''),
('def', 'information_schema', 'COLUMNS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2013-11-28 14:33:13', '2013-11-28 14:33:13', NULL, 'utf8_general_ci', NULL, 'max_rows=2802', ''),
('def', 'information_schema', 'COLUMN_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2565, 0, 16757145, 0, 0, NULL, '2013-11-28 14:33:13', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6540', ''),
('def', 'information_schema', 'ENGINES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 490, 0, 16574250, 0, 0, NULL, '2013-11-28 14:33:13', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=34239', ''),
('def', 'information_schema', 'EVENTS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2013-11-28 14:33:13', '2013-11-28 14:33:13', NULL, 'utf8_general_ci', NULL, 'max_rows=618', ''),
('def', 'information_schema', 'FILES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2677, 0, 16758020, 0, 0, NULL, '2013-11-28 14:33:13', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6267', ''),
('def', 'information_schema', 'GLOBAL_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2013-11-28 14:33:13', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'GLOBAL_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2013-11-28 14:33:13', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'KEY_COLUMN_USAGE', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4637, 0, 16762755, 0, 0, NULL, '2013-11-28 14:33:13', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3618', ''),
('def', 'information_schema', 'PARAMETERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2013-11-28 14:33:13', '2013-11-28 14:33:13', NULL, 'utf8_general_ci', NULL, 'max_rows=6050', ''),
('def', 'information_schema', 'PARTITIONS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2013-11-28 14:33:13', '2013-11-28 14:33:13', NULL, 'utf8_general_ci', NULL, 'max_rows=5579', ''),
('def', 'information_schema', 'PLUGINS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2013-11-28 14:33:13', '2013-11-28 14:33:13', NULL, 'utf8_general_ci', NULL, 'max_rows=11328', ''),
('def', 'information_schema', 'PROCESSLIST', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2013-11-28 14:33:13', '2013-11-28 14:33:13', NULL, 'utf8_general_ci', NULL, 'max_rows=23899', ''),
('def', 'information_schema', 'PROFILING', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 308, 0, 16562084, 0, 0, NULL, '2013-11-28 14:33:13', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=54471', ''),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4814, 0, 16767162, 0, 0, NULL, '2013-11-28 14:33:13', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3485', ''),
('def', 'information_schema', 'ROUTINES', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2013-11-28 14:33:13', '2013-11-28 14:33:13', NULL, 'utf8_general_ci', NULL, 'max_rows=583', ''),
('def', 'information_schema', 'SCHEMATA', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3464, 0, 16738048, 0, 0, NULL, '2013-11-28 14:33:13', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=4843', ''),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2179, 0, 16736899, 0, 0, NULL, '2013-11-28 14:33:13', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7699', ''),
('def', 'information_schema', 'SESSION_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2013-11-28 14:33:13', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'SESSION_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2013-11-28 14:33:13', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'STATISTICS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 5753, 0, 16752736, 0, 0, NULL, '2013-11-28 14:33:13', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2916', ''),
('def', 'information_schema', 'TABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 9450, 0, 16764300, 0, 0, NULL, '2013-11-28 14:33:13', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=1775', ''),
('def', 'information_schema', 'TABLESPACES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 6951, 0, 16772763, 0, 0, NULL, '2013-11-28 14:33:13', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2413', ''),
('def', 'information_schema', 'TABLE_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2504, 0, 16721712, 0, 0, NULL, '2013-11-28 14:33:13', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6700', ''),
('def', 'information_schema', 'TABLE_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2372, 0, 16748692, 0, 0, NULL, '2013-11-28 14:33:13', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7073', ''),
('def', 'information_schema', 'TRIGGERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2013-11-28 14:33:13', '2013-11-28 14:33:13', NULL, 'utf8_general_ci', NULL, 'max_rows=569', ''),
('def', 'information_schema', 'USER_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 1986, 0, 16726092, 0, 0, NULL, '2013-11-28 14:33:13', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=8447', ''),
('def', 'information_schema', 'VIEWS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2013-11-28 14:33:13', '2013-11-28 14:33:13', NULL, 'utf8_general_ci', NULL, 'max_rows=6935', ''),
('def', 'information_schema', 'INNODB_CMP_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 13107200, 0, 0, NULL, '2013-11-28 14:33:13', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_TRX', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4534, 0, 16766732, 0, 0, NULL, '2013-11-28 14:33:13', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3700', ''),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2013-11-28 14:33:13', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_LOCK_WAITS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 599, 0, 16749238, 0, 0, NULL, '2013-11-28 14:33:13', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=28008', ''),
('def', 'information_schema', 'INNODB_CMPMEM', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2013-11-28 14:33:13', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_CMP', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 13107200, 0, 0, NULL, '2013-11-28 14:33:13', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_LOCKS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 31244, 0, 16746784, 0, 0, NULL, '2013-11-28 14:33:13', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=536', ''),
('def', 'am1b', 'users', 'BASE TABLE', 'InnoDB', 10, 'Compact', 1, 16384, 16384, 0, 0, 8388608, NULL, '2013-11-07 11:56:17', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'am1b-fotosjaak', 'login', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 8388608, 1, '2013-11-28 14:03:42', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'am1b-fotosjaak', 'user', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 8388608, NULL, '2013-11-28 14:31:31', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'am1b-fotosjaak', 'users', 'BASE TABLE', 'InnoDB', 10, 'Compact', 1, 16384, 16384, 0, 0, 8388608, NULL, '2013-11-22 10:07:20', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'mysql', 'columns_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 227994731135631359, 4096, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 13:45:10', NULL, 'utf8_bin', NULL, '', 'Column privileges'),
('def', 'mysql', 'db', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 2, 440, 880, 123848989752688639, 5120, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 13:45:10', '2012-04-19 13:45:10', 'utf8_bin', NULL, '', 'Database privileges'),
('def', 'mysql', 'event', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 13:45:10', NULL, 'utf8_general_ci', NULL, '', 'Events'),
('def', 'mysql', 'func', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 162974011515469823, 1024, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 13:45:10', NULL, 'utf8_bin', NULL, '', 'User defined functions'),
('def', 'mysql', 'general_log', 'BASE TABLE', 'CSV', 10, 'Dynamic', 0, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, '', 'General log'),
('def', 'mysql', 'help_category', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 38, 581, 22078, 163536961468891135, 3072, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 13:45:10', NULL, 'utf8_general_ci', NULL, '', 'help categories'),
('def', 'mysql', 'help_keyword', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 465, 197, 91605, 55450570411999231, 16384, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 13:45:10', NULL, 'utf8_general_ci', NULL, '', 'help keywords'),
('def', 'mysql', 'help_relation', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 1029, 9, 9261, 2533274790395903, 19456, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 13:45:10', NULL, 'utf8_general_ci', NULL, '', 'keyword-topic relation'),
('def', 'mysql', 'help_topic', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 508, 875, 444876, 281474976710655, 20480, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 13:45:10', NULL, 'utf8_general_ci', NULL, '', 'help topics'),
('def', 'mysql', 'host', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 110056715893866495, 2048, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 13:45:10', NULL, 'utf8_bin', NULL, '', 'Host privileges;  Merged with database privileges'),
('def', 'mysql', 'ndb_binlog_index', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 13:45:10', NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'mysql', 'plugin', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 13:45:10', NULL, 'utf8_general_ci', NULL, '', 'MySQL plugins'),
('def', 'mysql', 'proc', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 13:45:10', NULL, 'utf8_general_ci', NULL, '', 'Stored Procedures'),
('def', 'mysql', 'procs_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239253730204057599, 4096, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 13:45:10', NULL, 'utf8_bin', NULL, '', 'Procedure privileges'),
('def', 'mysql', 'proxies_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 1, 693, 693, 195062158860484607, 5120, 0, NULL, '2012-04-19 13:45:10', '2012-04-19 13:45:10', '2012-04-19 13:45:10', 'utf8_bin', NULL, '', 'User proxy privileges'),
('def', 'mysql', 'servers', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 433752939111120895, 1024, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 13:45:10', NULL, 'utf8_general_ci', NULL, '', 'MySQL Foreign Servers table'),
('def', 'mysql', 'slow_log', 'BASE TABLE', 'CSV', 10, 'Dynamic', 0, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, '', 'Slow log'),
('def', 'mysql', 'tables_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239535205180768255, 4096, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 13:45:10', NULL, 'utf8_bin', NULL, '', 'Table privileges'),
('def', 'mysql', 'time_zone', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 1970324836974591, 1024, 0, 1, '2012-04-19 13:45:09', '2012-04-19 13:45:10', NULL, 'utf8_general_ci', NULL, '', 'Time zones'),
('def', 'mysql', 'time_zone_leap_second', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 3659174697238527, 1024, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 13:45:10', NULL, 'utf8_general_ci', NULL, '', 'Leap seconds information for time zones'),
('def', 'mysql', 'time_zone_name', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 55450570411999231, 1024, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 13:45:10', NULL, 'utf8_general_ci', NULL, '', 'Time zone names'),
('def', 'mysql', 'time_zone_transition', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 4785074604081151, 1024, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 13:45:10', NULL, 'utf8_general_ci', NULL, '', 'Time zone transitions'),
('def', 'mysql', 'time_zone_transition_type', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 10696049115004927, 1024, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 13:45:10', NULL, 'utf8_general_ci', NULL, '', 'Time zone transition types'),
('def', 'mysql', 'user', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 4, 53, 212, 281474976710655, 2048, 0, NULL, '2012-04-19 13:45:09', '2012-04-19 13:45:10', NULL, 'utf8_bin', NULL, '', 'Users and global privileges'),
...
('def', 'selma', 'student', 'BASE TABLE', 'InnoDB', 10, 'Compact', 3, 5461, 16384, 0, 0, 8388608, NULL, '2013-11-15 08:34:53', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'selma', 'werknemer', 'BASE TABLE', 'InnoDB', 10, 'Compact', 20, 819, 16384, 0, 16384, 8388608, NULL, '2013-11-08 10:18:51', NULL, NULL, 'latin1_swedish_ci', NULL, '', '');
...
('def', 'am1b-fotosjaak', 'PRIMARY', 'am1b-fotosjaak', 'login', 'PRIMARY KEY'),
('def', 'am1b-fotosjaak', 'PRIMARY', 'am1b-fotosjaak', 'user', 'PRIMARY KEY'),
...
('def', 'selma', 'PRIMARY', 'selma', 'werknemer', 'PRIMARY KEY');
...
--
-- Gegevens worden uitgevoerd voor tabel `INNODB_CMP_RESET`
--
...
--
-- Gegevens worden uitgevoerd voor tabel `INNODB_CMPMEM_RESET`
--
...
--
-- Gegevens worden uitgevoerd voor tabel `INNODB_CMPMEM`
--
...
--
-- Gegevens worden uitgevoerd voor tabel `INNODB_CMP`
--
...
--
-- Tabelstructuur voor tabel `columns_priv`
--
...
--
-- Gegevens worden uitgevoerd voor tabel `db`
--
...
--
-- Tabelstructuur voor tabel `func`
--
...
--
-- Tabelstructuur voor tabel `general_log`
--
...
--
-- Tabelstructuur voor tabel `help_category`
--
...
--
-- Gegevens worden uitgevoerd voor tabel `help_category`
--
...
--
-- Tabelstructuur voor tabel `help_keyword`
--
...
--
-- Gegevens worden uitgevoerd voor tabel `help_keyword`
--
...
--
-- Tabelstructuur voor tabel `help_relation`
--
...
--
-- Gegevens worden uitgevoerd voor tabel `help_relation`
--
...
--
-- Tabelstructuur voor tabel `help_topic`
--
...
--
-- Gegevens worden uitgevoerd voor tabel `help_topic`
--
...
--
-- Tabelstructuur voor tabel `ndb_binlog_index`
--
...
--
-- Tabelstructuur voor tabel `proc`
--
...
--
-- Tabelstructuur voor tabel `procs_priv`
--
...
--
-- Tabelstructuur voor tabel `proxies_priv`
--
...
--
-- Gegevens worden uitgevoerd voor tabel `proxies_priv`
--
...
--
-- Tabelstructuur voor tabel `slow_log`
--
...
--
-- Tabelstructuur voor tabel `tables_priv`
--
...
--
-- Tabelstructuur voor tabel `time_zone`
--
...
--
-- Tabelstructuur voor tabel `time_zone_leap_second`
--
...
--
-- Tabelstructuur voor tabel `time_zone_name`
--
...
--
-- Tabelstructuur voor tabel `time_zone_transition`
--
...
--
-- Tabelstructuur voor tabel `time_zone_transition_type`
--
...
--
-- Tabelstructuur voor tabel `cond_instances`
--
...
--
-- Tabelstructuur voor tabel `events_waits_current`
--
...
--
-- Tabelstructuur voor tabel `events_waits_history`
--
...
--
-- Tabelstructuur voor tabel `events_waits_history_long`
--
...
--
-- Tabelstructuur voor tabel `events_waits_summary_by_instance`
--
...
--
-- Tabelstructuur voor tabel `events_waits_summary_by_thread_by_event_name`
--
...
--
-- Tabelstructuur voor tabel `events_waits_summary_global_by_event_name`
--
...
--
-- Tabelstructuur voor tabel `file_instances`
--
...
--
-- Tabelstructuur voor tabel `file_summary_by_event_name`
--
...
--
-- Tabelstructuur voor tabel `file_summary_by_instance`
--
...
--
-- Tabelstructuur voor tabel `mutex_instances`
--
...
--
-- Tabelstructuur voor tabel `performance_timers`
--
...
--
-- Gegevens worden uitgevoerd voor tabel `performance_timers`
--
...
--
-- Tabelstructuur voor tabel `rwlock_instances`
--
...
--
-- Tabelstructuur voor tabel `setup_consumers`
--
...
--
-- Gegevens worden uitgevoerd voor tabel `setup_consumers`
--
...
--
-- Tabelstructuur voor tabel `setup_instruments`
--
...
--
-- Tabelstructuur voor tabel `setup_timers`
--
...
--
-- Gegevens worden uitgevoerd voor tabel `setup_timers`
--
...
-- Databank: `selma`
--
CREATE DATABASE `selma` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `selma`;
...
INSERT INTO `student` (`Studentnummer`, `Achternaam`, `Roepnaam`, `Klas`, `Tel`, `Email`, `Geboortedatum`) VALUES
(5, 'Helmer', 'Jan', 'Mb1A', 667, 'helmer@gmail.com', '2/3/1990'),
(6, 'Verink', 'Mathijs', 'Mb1A', 6789, 'Verink@hotmail.com', '5/6/1993'),
(8, 'Hanoi', 'Koos', 'Mb1B', 8901, 'hanoi@yahoo.nl', '11/3/1993');
...
CREATE TABLE IF NOT EXISTS `werknemer` (
  ...
  `sofinummer` varchar(10) NOT NULL,
  PRIMARY KEY (`wnr`),
  KEY `ind_achternaam` (`achternaam`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `werknemer` (`wnr`, `achternaam`, `voorletters`, `voorvoegsel`, `adres`, `postcode`, `woonplaats`, `tel`, `datum_in_dienst`, `sal`, `chef`, `sofinummer`) VALUES
(10, 'Buck', 'A.P.', 'De', 'Lindelaan 2', '1055 PP', 'Amsterdam', '020-9876889', '1980-01-01', '4567.00', 99, '1012'),
(12, 'Brasser', 'K.J.', '', 'Lindelaan 18', '1055 PP', 'Amsterdam', '020-9876443', '1988-10-12', '2148.80', 20, '1234'),
(16, 'Lievense', 'I.H.', '', 'Hoofdstraat 3', '8948 KK', 'Leeuwarde', '058-6675434', '2004-10-14', '3148.54', 30, '5223'),
(18, 'Vliet', 'P.', 'Van', 'Kade 34', '1056 KM', 'Amsterdam', '020-9322899', '2001-09-28', '1999.70', 20, '2421'),
(19, 'Umbgrove', 'M.M.', '', 'Talmalaan 3', '4351 JG', 'Vlissingen', '0118-768221', '2006-11-13', '2988.10', 30, '8656'),
(20, 'Maas', 'L.C.', '', 'bosjeslaan 3', '3085 HG', 'Rotterdam', '010-2346777', '2011-02-01', '3011.30', 10, '8566'),
(25, 'Neve', 'G.', 'De', 'Prinsengracht 20', '1048 GP', 'Amsterdam', '020-7654441', '1999-05-15', '3280.67', 40, '8687'),
(26, 'Geel', 'J.M.G.', '', 'Plein 43', '3568 JL', 'Utrecht', '030-5671118', '2010-08-12', '2981.10', 30, '7445'),
(28, 'Zeeuw', 'A.J.', '', 'Julianalaan 6', '5610JP', 'Eindhoven', '040-5908891', '1998-04-11', '3100.00', 35, '7533'),
(30, 'Merk', 'J.', '', 'Eikenlaan 23', '3086 GH', 'Rotterdam', '010-2334990', '2010-01-30', '4300.50', 40, '1244'),
(31, 'Paree', 'G.M.', '', 'Kade 44', '1056 KM', 'Amsterdam', '020-9322780', '2005-02-06', '1780.50', 35, '6777'),
(35, 'Jonge', 'L.M.', 'De', 'Gracht 11', '6222 AG', 'Maastricht', '043-9012670', '1990-03-21', '2118.00', 40, '8535'),
(40, 'Willegen', 'W.M.', 'Van', 'Beukenlaan 2', '3088 LM', 'Rotterdam', '010-6671246', '2000-12-09', '4717.90', 99, '6855'),
(45, 'Jobse', 'G.C.', '', 'Singel 128', '3088 HJ', 'Rotterdam', '010-9051230', '2010-04-12', '4990.95', 40, '3222'),
(47, 'Jansma', 'L.M.', '', 'Singel 48', '1038 JG', 'Amsterdam', '020-1129045', '1998-06-11', '3124.56', 35, '1444'),
(48, 'Bos', 'P.', '', 'Beukenlaan 18', '3088 LM', 'Rotterdam', '010-6671234', '2007-08-21', '3410.34', 60, '6344'),
(50, 'Loof', 'J.G.', 'De', 'Plein 12', '3568 JL', 'Utrecht', '030-5671211', '2001-11-15', '2357.00', 10, '6334'),
(52, 'Maas', 'M.C.', '', 'Hogeweg 12', '3078 KL', 'Rotterdam', '010-1123889', '1999-09-01', '2849.90', 60, '9779'),
(60, 'Vliet', 'P.C.', 'Van der', 'Oranjeplein 23', '5655 AA', 'Eindhoven', '040-3434567', '1990-04-01', '3878.25', 10, '3264'),
(99, 'Koning', 'C.', 'De', 'Singel 2', '3088 JK', 'Rotterdam', '010-9051229', '1980-01-01', '5690.00', 0, '7244');
--
-- Databank: `test`
--
